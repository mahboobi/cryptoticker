...
class Log_file extends Log
{
    ...
    // to change filenames without creating another instance - tuhin
    function setFileName($fileName){
        if($fileName) $this->_filename = $fileName;
    }

    // added by tuhin to add multiple messages in one shot (it wont lock/unlock multiple times)
    function logMessages($messages, $priority = null) { 
        /* If a priority hasn't been specified, use the default value. */
        if ($priority === null) {
            $priority = $this->_priority;
        }
        ...
        $line = ''; // added by tuhin after copying from the above log()
        ...
        // close this file here, as its no longer needed
        $this->close(); // added by tuhin

        /* Notify observers about this log message. */
        $this->_announce(array('priority' => $priority, 'message' => $messages)); // shd be 'messages' => $messages
